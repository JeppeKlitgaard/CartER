...
{
    if (FAKE_ROTARY_ENCODERS) {
        rot_encoder1 = new FakeCustomAMS_5600();
        rot_encoder2 = new FakeCustomAMS_5600();
    } else {
        rot_encoder1 = new RealCustomAMS_5600();
        rot_encoder2 = new RealCustomAMS_5600();
    }
